---
layout: post
title: Upload multipart files to AWS S3 using the AWS s3api tool.
---
...
You can [check the Github Repository here](https://github.com/lpossamai/awsS3-multipart-upload-script).
...
7. Check AWS documentation for next step. You'll have to run the [complete-multipart-upload](https://docs.aws.amazon.com/cli/latest/reference/s3api/complete-multipart-upload.html) command.
